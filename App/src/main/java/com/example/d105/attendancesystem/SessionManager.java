...
public class SessionManager {
    ...
    private static final String KEY_IS_PASS = "password";
    ...
    public void setLogin(String email,String password,boolean isLoggedIn) {


        editor.putString(KEY_IS_EMAIL, email);
        editor.putString(KEY_IS_PASS, password);
